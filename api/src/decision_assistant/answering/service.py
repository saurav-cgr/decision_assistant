...
ANSWER_SYSTEM_INSTRUCTION = (
    ...
    "answer with the value recorded at that time. Do not replace that historical "
    "value with a later revision; mention supersession only when relevant.\n"
    ...
    "For every supported facet, create a claim that directly answers it, set "
    "central=true, and include every supporting passage ID in passage_ids. "
    "Every passage ID used by a central claim must have a citation.\n"
    ...
    "Do not mark a directly supported facet as unsupported. When evidence is "
    "insufficient, record only the specific missing facet in unsupported_facets. "
    "If at least one facet is supported, answer it and withhold only unsupported "
    "facets. Fully abstain only when no requested facet has direct support."
)
